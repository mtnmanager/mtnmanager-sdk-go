...
type MtnManagerAPI interface {
	...
	*/
	GetAmenities(ctx context.Context) ApiGetAmenitiesRequest

	// GetAmenitiesExecute executes the request
	//  @return []Amenity
	GetAmenitiesExecute(r ApiGetAmenitiesRequest) ([]Amenity, *http.Response, error)
...
GetAmenities Get amenities
 ...
 @return ApiGetAmenitiesRequest
*/
func (a *MtnManagerAPIService) GetAmenities(ctx context.Context) ApiGetAmenitiesRequest {
	return ApiGetAmenitiesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return []Amenity
func (a *MtnManagerAPIService) GetAmenitiesExecute(r ApiGetAmenitiesRequest) ([]Amenity, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []Amenity
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MtnManagerAPIService.GetAmenities")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/report/amenities"
